%!TEX program = xelatex
\documentclass[WordOneHalf, print]{XDUthesis}   %%启用默认字体设置，打印样式
% 参数设置：
%     功能设置：
...
\title{面向深度学习的自适应优化算法设计}
\author{刘臻劼}
\date{\qquad 年\qquad 月\qquad 日} %%%  请勿编辑这行
%题目拆分：用于封面
\septitleA{面向深度学习的自适应}%如果论文题目长度<=11中文字符只需填此项即可B项空着
\septitleB{优化算法设计}%如果论文题目长度>11中文字符, 建议拆分为10+x or 11+x 将剩余x个字符填在此处。
\class{1903071}%班级号
\schoolnumber{19030700016}%学号
\major{数据科学与大数据技术}%专业
